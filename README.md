...
## Install
If you just want to use fca-noder, you should use this command:
```bash
npm install fca-noder
```
It will download `fca-noder` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install Ber906/fca.noder or npm i git+https://github.com/Ber906/fca.noder
```
